...
const Header = ({ activeHeading }) => {
  ...
  return (
    <>
      ...
      {/* header bottom */}
      <div
        className={`${active === true ? "fixed top-0 left-0 shadow-sm z-10" : null
          ...
          <div className="flex">
            ...
            <div className={`${styles.noramlFlex}`}>
              <div className="relative cursor-pointer mr-[15px]">
                <Link to={isAuthenticate ? `${userPath[user.roles]}` : "/sign-up"}>
                  {user && isAuthenticate ? (
                    <img
                      src={isAuthenticate ? user.photoURL : avatar}
                      alt="avatar"
