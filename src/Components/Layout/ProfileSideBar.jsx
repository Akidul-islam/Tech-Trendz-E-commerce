  ...
  return (
    <div className="p-4 z-30 pt-8 bg-white shadow-sm rounded-[10px] w-full">
      <div
        ...
        <span
          className={`pl-3 ${active === 1 ? "text-[#3957db]" : ""
            } hidden 800px:block`}>
          Profile
        </span>
      </div>
      ...
      <div
        ...
        <span
          className={`pl-3 ${active === 2 ? "text-[#3957db]" : ""
            }  hidden 800px:block`}>
          Orders
        </span>
      </div>
      ...
      <div
        ...
        />
        <span
          className={`pl-3 ${active === 3 ? "text-[#3957db]" : ""
            }  hidden 800px:block`}>
          Refunds
        </span>
      </div>
      ...
      <div
        ...
        <span
          className={`pl-3 ${active === 4 ? "text-[#3957db]" : ""
            }  hidden 800px:block`}>
          Inbox
        </span>
      </div>
      ...
      <div
        ...
        />
        <span
          className={`pl-3 ${active === 5 ? "text-[#3957db]" : ""
            }  hidden 800px:block`}>
          Track Orders
        </span>
      </div>
      ...
      <div
        ...
        <span
          className={`pl-3 ${active === 6 ? "text-[#3957db]" : ""
            }  hidden 800px:block`}>
          Change Password
        </span>
      </div>
      ...
      <div
        ...
        <span
          className={`pl-3 ${active === 7 ? "text-[#3957db]" : ""
            } hidden 800px:block`}>
          Address
        </span>
      </div>
      ...
      <div
        ...
        <span
          className={`pl-3 ${active === 8 ? "text-[#3957db]" : ""
            } hidden 800px:block`}>
          Logout
        </span>
      </div>
