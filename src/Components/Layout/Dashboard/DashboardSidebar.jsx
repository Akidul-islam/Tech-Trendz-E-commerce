      ...
      <div
        ...
        <div
          ...
          <Link to="/dashboard" className="w-full flex items-center">
            ...
            <h5
              className={` ${active === 1 ? "text-[#3957db]" : "#555"
        ...
        <div
          ...
          <Link to="/dashboard-orders" className="flex w-full items-center">
            ...
            />
            <h5
              className={` ${active === 2 ? "text-[#3957db]" : "#555"
                } pl-3 hidden 800px:block text-[18px] font-[600]`}>
              All Orders
            </h5>
          </Link>
        ...
        <div
          ...
          <Link to="/dashboard-products" className="flex w-full items-center">
            ...
            <h5
              className={` ${active === 3 ? "text-[#3957db]" : "#555"
                } pl-3 hidden 800px:block text-[18px] font-[600]`}>
              All Products
            </h5>
          </Link>
        ...
        <div
          ...
          <Link
            ...
            />
            <h5
              className={` ${active === 4 ? "text-[#3957db]" : "#555"
                } pl-3 hidden 800px:block text-[18px] font-[600]`}>
              Create Product
            </h5>
          </Link>
        ...
        <div
          ...
          <Link to="/dashboard-events" className="flex w-full items-center">
            ...
            />
            <h5
              className={` ${active === 5 ? "text-[#3957db]" : "#555"
                } pl-3 hidden 800px:block text-[18px] font-[600]`}>
              All Events
            </h5>
          </Link>
        ...
        <div
          ...
          <Link
            ...
            <h5
              className={` ${active === 6 ? "text-[#3957db]" : "#555"
                } pl-3 hidden 800px:block text-[18px] font-[600]`}>
              Create Event
            </h5>
          </Link>
        ...
        <div
          ...
          <Link
            ...
            <h5
              className={` ${active === 7 ? "text-[#3957db]" : "#555"
                } pl-3 hidden 800px:block text-[18px] font-[600]`}>
              Withdraw Money
            </h5>
          </Link>
        ...
        <div
          ...
          <Link to="/dashboard-messages" className="flex w-full items-center">
            ...
            />
            <h5
              className={` ${active === 8 ? "text-[#3957db]" : "#555"
                } pl-3 hidden 800px:block text-[18px] font-[600]`}>
              Shop Inbox
            </h5>
          </Link>
        ...
        <div
          ...
          <Link to="/dashboard-cupons" className="flex w-full items-center">
            ...
            />
            <h5
              className={` ${active === 9 ? "text-[#3957db]" : "#555"
                } pl-3 hidden 800px:block text-[18px] font-[600]`}>
              Discount Codes
            </h5>
          </Link>
        ...
        <div
          ...
          <Link to="/dashboard-settings" className="flex w-full items-center">
            ...
            <h5
              className={` ${active === 10 ? "text-[#3957db]" : "#555"
                } pl-3 hidden 800px:block text-[18px] font-[600]`}>
              Settings
            </h5>
          </Link>
