...
export const pCategoryList = {
  mainCategory: ['Electronics', 'Groceries', 'Fashion', 'Services'],
  sub_category: [
    {
      title: 'Electronics',
      category: ['Computers & Laptops', 'Smartphones & Accessories', 'Audio & Headphones', 'Cameras & Photography']
    },
    {
      title: 'Groceries',
      category: ['Fruits', 'Vegetables', ' Dairy', 'Meat and fish', 'Meat alternatives']
    },
    {
      title: 'Fashion',
      category: ['Bohemian Style', 'Classic Style', 'Business Casual style', 'Vintage Style', 'Ethnic Style']

    },
    {
      title: 'Services',
      category: ['web design course', 'software application', 'shopify service', 'fiver service']
    }
  ]
}
...
export const footercompanyLinks = [
  {
    name: "Game & Video",
    link: "/products?title=Music%20and%20Gaming",
  },
  {
    name: "Phone &Tablets",
    link: "/products?title=Mobile%20and%20Tablets",
  },
  {
    name: "Computers & Laptop",
    link: "/products?title=Computers%20and%20Laptops",
  },
  {
    name: "Sport Watches",
    link: "/products?title=Accesories",
  },
  {
    name: "Events",
    link: "/events",
